<section id="section1">
    <header data-backgrounds="backgrounds">
        <a href="http://selectedteste1.rf.gd/Trabalho_do_Inter"><img src="https://i.im.ge/2023/10/06/NBepR1.image-removebg-preview.png"></a>
        ...
        <ul id="menu" data-backgrounds="backgrounds">
            ...
            <li class="item hidden"><a href="http://selectedteste1.rf.gd/forms" class="header_links"><span id="Login" class="data-font">Login</span><span id="perfil" class="material-symbols-outlined data-font">account_circle</span></a></li>
        <!-- <li class="item"></li> -->
    ...
    <div class="wrapper">
        <form action="" method="POST">
            ...
            <div class="resgister-link">
                <p>Não possuí conta? <a href="http://selectedteste1.rf.gd/forms/forms-cadastro/cadastro.html">Cadastre-se</a></p>
            </div>
        </form>
    </div>
</div>
