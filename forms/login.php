<section id="section1">
    <header data-backgrounds="backgrounds">
        <a href="http://selectedteste1.rf.gd/Trabalho_do_Inter"><img src="https://i.im.ge/2023/10/06/NBepR1.image-removebg-preview.png" data-backgroundImage="backgrounds_image"></a>
        ...
        <ul id="menu" data-backgrounds="backgrounds">
            ...
            <li class="item hidden data-font"><a class="lastNotices"  href="http://selectedteste1.rf.gd/Trabalho_do_Inter">Últimas notícias</a></li>
        ...
        <div id="menuSide">
            ...
            <ul id="menuSide_ul">
                ...
                <li class="menuSide_li"><a href="http://selectedteste1.rf.gd/pagina_das_doencas"><span class="material-symbols-outlined">coronavirus</span>Doenças/sintomas</a></li>
    ...
    <ul class="pages data-font" data-backgrounds="backgrounds">
        <li class="page"><a href="http://selectedteste1.rf.gd/pagina_dos_remedios" class="pages_a" data-backgrounds="backgrounds">Remédios</a></li>
        <li class="page"><a href="http://selectedteste1.rf.gd/pagina_das_doencas" class="pages_a" data-backgrounds="backgrounds">Doenças/sintomas</a></li>
        <li class="page"><a href="http://selectedteste1.rf.gd/forms/forms-cadastro/cadastro.html" class="pages_a" data-backgrounds="backgrounds">Cadastro</a></li>
        <li class="page"><a href="http://selectedteste1.rf.gd/vacinacao" class="pages_a" data-backgrounds="backgrounds">Vacinação</a></li>
    </ul>       
</section>

<div class="box" data-backgroundImage="backgrounds_image">
    <div class="wrapper" data-backgrounds="backgrounds">
        <form action="" method="POST">
            <h1 id="statusLogin" class="data-font">Login</h1>
    
            <div class="input-box">
                <input class="data-font" type="text" id="account_name" placeholder="Primeiro nome" name="nome" required>
                <i class='bx bxs-user-circle'></i>
                <small class="error-message"></small>
            </div>
    
            <div class="input-box">
                <input class="data-font" type="text" placeholder="E-mail" name="email" required>
                <i class='bx bxs-envelope'></i>
                <small class="error-message"></small>
            </div>
    
            <div class="input-box">
                <input class="data-font" type="password" placeholder="Senha" name="senha" required>
                <i class='bx bxs-lock-alt' ></i>
                <small class="error-message"></small>
            </div>
    
            <div class="remember-forgot">
                <label class="data-font"><input type="checkbox"> Lembrar-me</label>
            </div>
    
            <input type="submit" id="sendInformations" name="datas" class="btn data-font" value="Entrar"></input>
    
            <div class="resgister-link">
                <p class="data-font">Não possuí conta? <a href="http://selectedteste1.rf.gd/forms/forms-cadastro/cadastro.html">Cadastre-se</a></p>
            </div>
        </form>
    </div>
</div>
...
<footer id="footer" data-backgrounds="backgrounds">
    <div><img src="https://i.im.ge/2023/10/06/NBepR1.image-removebg-preview.png" alt="" data-backgroundImage="backgrounds_image"></div>
    ...
    <div>
        ...
        <ul id="footer_first_ul">
            <li>
                <a href="http://selectedteste1.rf.gd/Trabalho_do_Inter" class="data-font">Home</a>
            </li>
            <li>
