<section id="section1">
    <header data-backgrounds="backgrounds">
        ...
        <div id="menuSide">
            ...
            <ul id="menuSide_ul">
                ...
                <li class="menuSide_li"><a href="https://conradoec.github.io/Trabalho_do_Inter/pagina_das_doencas"><span class="material-symbols-outlined">coronavirus</span>Doenças/sintomas</a></li>
    ...
    <ul class="pages data-font" data-backgrounds="backgrounds">
        <li class="page"><a href="https://conradoec.github.io/Trabalho_do_Inter/pagina_dos_remedios" class="pages_a" data-backgrounds="backgrounds">Remédios</a></li>
        <li class="page"><a href="https://conradoec.github.io/Trabalho_do_Inter/pagina_das_doencas" class="pages_a" data-backgrounds="backgrounds">Doenças/sintomas</a></li>
        <li class="page"><a href="https://conradoec.github.io/Trabalho_do_Inter/forms/forms-cadastro/cadastro.html" class="pages_a" data-backgrounds="backgrounds">Cadastro</a></li>
        <li class="page"><a href="https://conradoec.github.io/Trabalho_do_Inter/vacinacao" class="pages_a" data-backgrounds="backgrounds">Caderneta de vacinação</a></li>
    </ul>       
</section>
    ...
    <div class="wrapper">
        <form action="" method="POST">
            ...
            <div class="resgister-link">
                <p>Não possuí conta? <a href="https://conradoec.github.io/Trabalho_do_Inter/forms/forms-cadastro/cadastro.html">Cadastre-se</a></p>
            </div>
        </form>
    </div>
</div>
